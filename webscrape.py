...
# Much better filter for python jobs, becomes case insensitive and only looks for python. ONlY extracts the text. 
python_jobs = results.find_all('h2', string=lambda text: 'python' in text.lower())
#print(len(python_jobs))

# building off of python_jobs, this extracts the URL of the jobs posting. Html attributes can be extracted using the square-brackets notation.
